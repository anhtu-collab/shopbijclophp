 ...
 <main>
        ...
        <div class="swiper-slide">
          <div class="overflow-hidden position-relative h-100">
            ...
            <div class="slideshow-text container position-absolute start-50 top-50 translate-middle">
              ...
              <a href="{{ $slide->link }}"
                class="btn-link btn-link_lg default-underline fw-medium animate animate_fade animate_btt animate_delay-7">Mua Sắm Ngay</a>
            </div>
          </div>
        </div>
        @endforeach
    ...
    <div class="container mw-1620 bg-white border-radius-10">
      ...
      <section class="category-carousel container">
        <h2 class="section-title text-center mb-3 pb-xl-2 mb-xl-4">Danh Mục Sản Phẩm</h2>
      ...
      <section class="hot-deals container">
        <h2 class="section-title text-center mb-3 pb-xl-3 mb-xl-4">Khuyến Mãi </h2>
        <div class="row">
          <div
                    ...
                    <div class="pc__info position-relative">
                      ...
                      <div class="product-card__price d-flex">
                        <span class="money price text-secondary">
                          @if($sproduct->sale_price)
                              <s>{{ number_format((int)$sproduct->regular_price, 0, ',', '.') }} đ</s>
                              {{ number_format((int)$sproduct->sale_price, 0, ',', '.') }} đ
                          @else
                              {{ number_format((int)$sproduct->regular_price, 0, ',', '.') }} đ
                          @endif
                        </span>
                      </div>
                    </div>
                ...
                <div class="product-card__price d-flex align-items-center">
                    <span class="money price text-secondary">
                       @if($fproduct->sale_price)
                          <s>{{ number_format((int)$fproduct->regular_price, 0, ',', '.') }} đ</s>
                          {{ number_format((int)$fproduct->sale_price, 0, ',', '.') }} đ
                      @else
                          {{ number_format((int)$fproduct->regular_price, 0, ',', '.') }} đ
                      @endif
                    </span>
                </div>
            </div>
