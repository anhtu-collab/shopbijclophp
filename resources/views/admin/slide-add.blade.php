                                ...
                                <div class="wg-box">
                                    <form class="form-new-product form-style-1" action="{{ route('admin.slide.store') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <fieldset class="name">
                                            ...
                                            <input class="flex-grow" type="text" placeholder="Nhập khẩu hiệu" name="tagline" tabindex="0" value="{{old('tagline')}}" aria-required="true" required="">
                                        </fieldset>
                                        ...
                                        <fieldset class="name">
                                            ...
                                            <input class="flex-grow" type="text" placeholder="Nhập tiêu đề" name="title" tabindex="0" value="{{old('title')}}" aria-required="true" required="">
                                        </fieldset>
                                        ...
                                        <fieldset class="name">
                                            ...
                                            <input class="flex-grow" type="text" placeholder="Nhập mô tả" name="subtitle" tabindex="0" value="{{old('subtitle')}}" aria-required="true" required="">
                                        </fieldset>
