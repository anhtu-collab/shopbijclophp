            ...
            <div class="col-lg-10">
                 <div class="wg-box">
                                    ...
                                    <div class="table-responsive">
                                         ...
                                         @endif
                                        <table class="table table-bordered table table-striped table-transaction">
                                            <tr>
                                                <th>Mã đơn hàng</th>
                                                <td>{{ $order->id }}</td>
                                    ...
                                    <div class="my-account__address-item col-md-6">
                                        <div class="my-account__address-item__detail">
                                            <p><strong>Họ tên:</strong> {{ $order->name }}</p>
                                                ...
                                                <p><strong>Khu vực:</strong> {{ $order->locality }}</p>

                                                <p><strong>Thành phố / Quốc gia:</strong> {{ $order->city }}, {{ $order->country }}</p>

                                                <p><strong>Ghi chú:</strong> {{ $order->landmark }}</p>
                                ...
                                <div class="wg-box mt-5">
                                    ...
                                    <table class="table table-striped table-bordered table-transaction">
                                        <tbody>
                                            ...
                                            <tr>
                                                <th>Tạm tính</th>
                                                <td>{{ number_format($order->subtotal ?? 0, 0, ',', '.') }} đ</td>

                                                <th>Thuế</th>
                                                <td>{{ number_format($order->tax ?? 0, 0, ',', '.') }} đ</td>
